...
const UserManagement: React.FC = () => {
	...
	const handleRowClick = (user: User) => {
		if (mode === "edit") {
			alert(`Edit: ${user.fname} ${user.lname}`);
		} else if (mode === "delete") {
			alert(`Delete: ${user.fname} ${user.lname}`);
		}
	};
					...
					<table className="min-w-full divide-y divide-gray-200">
						...
						<tbody className="bg-white divide-y divide-gray-200">
							{filteredUsers.map((user) => (
								...
								>
									<td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{user.enumber}</td>
									<td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{user.fname}</td>
									<td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{user.lname}</td>
									<td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{user.dname}</td>
									<td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{user.pname}</td>
									<td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{user.sname}</td>
