...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/jirasitkarunwong/Developer-local/dir-project/Reserve-Project/backend/database/out-files",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "443f476c5f63d69d84926e9a2ee72fbb4ff39f65ce3e32d2a4c65fc9d65d7555",
  "copyEngine": true
}
...
path.join(process.cwd(), "out-files/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "out-files/schema.prisma")
